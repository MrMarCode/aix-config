...
- **Commit messages must reference ticket numbers** if ticket number exists.
...
- No commit descriptions unless told to include one.
...
- **Don't push to an MR "in review"** — Creates extra diff noise.
- **Don't write an MR description**.
